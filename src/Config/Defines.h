...
constexpr double    MCS_PERIOD_MS = 1000.0 / MCS_FREQ; // Durée en µs entre deux mesures
...
constexpr float   DISTANCE_COD_GAUCHE_CENTRE = 137.5; // Unité : mm ; avant 138.5
constexpr float   DISTANCE_COD_DROITE_CENTRE = 137.5; // Unité : mm ; avant 138.5
#endif
